...
<a href="rekapitulasi_barang.php"><h3 class="text-medium text-center"><span class="glyphicon glyphicon-book">  Data Pembelian Kaset Playstation</span></h3></a>
...
<?php 
$per_hal=4;
$jumlah_record=mysqli_query($con, "SELECT * from buy");
...
<a href="buku_rekapitulasi.php" class="btn btn-default"><span class="glyphicon glyphicon-book"></span>  Rekapitulasi Buku Online</a>
<div class="mb-1"></div>
...
if(isset($_GET['cari'])){
    ...
    $periksa = mysqli_query($con, "SELECT * FROM buy where namabarang like '$carinamabarang'");
}else{
    $periksa = mysqli_query($con, "SELECT * FROM buy limit $start, $per_hal");
}
...
<div class="col-md-3" id="wrap">
    <div class="card">
        ...
        <div class="card-footer">
            <a href="detail_laku.php?id_buy=<?php echo $p["id_buy"];?>" class="btn glyphicon glyphicon-info-sign"> Detail</a>
            <a href="../../action/shop/act_hapus_laku.php?id_buy=<?php echo $p["id_buy"];?>" class="btn glyphicon glyphicon-trash"> Hapus</a>
        </div>
    </div>
</div>
<?php
